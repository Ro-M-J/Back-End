...
public class CEducacion {
    ...
    public ResponseEntity<Educacion>getByUd(@PathVariable("id") int id){
      if(!sEducacion.existsById(id)){
         return new ResponseEntity(new Mensaje("No ixise id "),HttpStatus.BAD_REQUEST);
      }
    ...
    public ResponseEntity<?> delete(@PathVariable("id") int id){
       ...
       if(sEducacion.existsById(id)){
          ...
          return new ResponseEntity(new Mensaje("Noexiste id"),HttpStatus.NOT_FOUND);
       }
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion ){
       ...
       return new ResponseEntity(new Mensaje("Educacin creada"),HttpStatus.OK);
